...
The function from the poset $P$ to the poset of join-irreducible elements of the distributive lattice of lower sets of $P$, which sends each $p \in P$ to the lower set generated by $p$, is a well-defined isomorphism of partial orders.
\end{proposition}
%%-/
...
-- A join-irreducible element of the lattice of lower sets has a unique maximal element.
